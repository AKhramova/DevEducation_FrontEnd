...
var textStart = document.querySelector('.text-start');
var numberAnswer = document.querySelector('.answer');
var hints = document.querySelector('.hints');
var textFinally = document.querySelector('.text-finally')

//block change setting
var attempsChange = document.querySelector('.attemps');
var minChange = document.querySelector('.minValue');
var maxChange = document.querySelector('.maxValue');
                ...
                if (userAnswer >= 1){
                    if(userAnswer === randomNumber){
                        ...
                        if(attemps-countClickGenerate > 0){
                            attempsLeft=attemps-countClickGenerate-1;
                        } else attempsLeft=0;
                        if(userAnswer < randomNumber){
                            textStart = ' ';
...
buttonExit.addEventListener('click', exitButton);
